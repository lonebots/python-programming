...
class Solution:
    def countStudents(self, students: List[int], sandwiches: List[int]) -> int:
        ...
        for sandwich in sandwiches : 
            ...
            # case 1 : no student want circle sandwich on the top of stack 
            if sandwich == 0 and circle_student_count == 0 :
                return square_student_count 
            
            # case 2 : no student want square sandwich on the top of stack 
            if sandwich == 1 and square_student_count == 0 :
                return circle_student_count 

            # case 3 : student takes the sandwich on top 
            if sandwich == 0 :
                circle_student_count -= 1 
            else : 
                square_student_count -= 1 

        return circle_student_count + square_student_count 